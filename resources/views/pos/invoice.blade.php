                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="pull-left m-t-30">
                                        <address>
                                          <b>Name:</b>  <span>{{$customer->name}}</span><br>
                                          <b>Shop Name:</b>  <span>{{$customer->shopname}}</span><br>
                            ...
                            <div class="hidden-print">
                                <div class="pull-right">
                                    ...
                                    <button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#pay_bill">Submit</button>
                                </div>
                            </div>
                        </div>
