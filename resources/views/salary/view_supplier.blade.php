                            ...
                            <div class="col-sm-12">
                                <div class="bg-picture text-center" style="background-image:url('{{asset('backend/images/big/bg.jpg')}}')">
                                    ...
                                    <div class="profile-info-name">
                                        <img src="{{asset('employee/'.$salary->employee->photo)}}" class="thumb-lg img-circle img-thumbnail" alt="profile-image">
                                        <h3 class="text-white">{{$salary->employee->name}}</h3>
                                    </div>
                                </div>
                                <!--/ meta -->
                            </div>
                                                ...
                                                <div class="panel panel-default panel-fill">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="about-info-p">
                                                            ...
                                                            <br/>
                                                            <p class="text-muted">{{$salary->employee->name}}</p>
                                                        </div>
                                                        <div class="about-info-p">
                                                            <strong>Mobile</strong>
                                                            <br/>
                                                            <p class="text-muted">{{$salary->employee->phone}}</p>
                                                        </div>
                                                        <div class="about-info-p">
                                                            <strong>Email</strong>
                                                            <br/>
                                                            <p class="text-muted">{{$salary->employee->email}}</p>
                                                        </div>
                                                        <div class="about-info-p m-b-0">
                                                            <strong>Location</strong>
                                                            <br/>
                                                            <p class="text-muted">{{$salary->address}}</p>
                                                        </div>
